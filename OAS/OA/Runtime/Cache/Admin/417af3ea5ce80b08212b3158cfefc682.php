					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding search">
							    <form class="form-horizontal" action="<?php echo U('Admin/Admin/userlist');?>" method="POST">
							...
							<div class="widget-content nopadding">
								...
								<?php if(is_array($userlist)): foreach($userlist as $key=>$v): ?><tr>
											...
											<td ><a><?php echo (date('Y-m-d H:m:s',$v["entrytime"])); ?></a></td>
											<td ><?php echo ($v["sex"]); ?></td>
											<td >
											     <a href="<?php echo U('Admin/Admin/modifyuser',array('username'=>$v['username']));?>">修改</a>
											     &nbsp;|&nbsp;<a href="<?php echo U('Admin/Admin/deluser',array('member_id'=>$v['member_id']));?>"">删除</a>
											     &nbsp;|&nbsp;<a href="<?php echo U('Admin/Admin/resetpassword',array('member_id'=>$v['member_id']));?>"">重置密码</a>
											</td>
