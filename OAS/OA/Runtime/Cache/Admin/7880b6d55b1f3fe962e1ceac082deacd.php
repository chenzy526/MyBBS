	...
	<body>
		...
		<div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav btn-group" >
                ...
                <li class="btn btn-inverse"><a title="" href="<?php echo U('Home/Login/password');?>"><i class="icon icon-cog"></i> <span class="text">修改密码</span></a></li>
					...
					<div class="span12">
						<div class="widget-box">
							<div class="widget-content nopadding">
								<form action="<?php echo U('Admin/runmodifyuser');?>" method="post" class="form-horizontal">
									<input type="hidden" name="member_id" value="<?php echo ($member_id); ?>"/>
									<div class="control-group">
										<label class="control-label">真实姓名：</label>
										<div class="controls">
											<input type="text" name="real_name" required value="<?php echo ($real_name); ?>"/>
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="work_id" required value="<?php echo ($work_id); ?>"/>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">所在部门：</label>
										<div class="controls">
											<input type="text" name="department" required maxlength="20" value="<?php echo ($department); ?>"/>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">工作职位：</label>
										<div class="controls">
											<input type="text" name="position" required maxlength="16" value="<?php echo ($position); ?>"/>
