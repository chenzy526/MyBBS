					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding search">
							    <form class="form-horizontal" action="<?php echo U('Admin/jfu');?>" method="POST">
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered table-striped" >
									...
									<tbody>
								<?php if(is_array($enterserverlist)): foreach($enterserverlist as $key=>$v): ?><tr>
											<td ><?php echo ($v["username"]); ?></td>
											<td ><?php echo ($v["plateform"]); ?></td>
											<td ><?php echo ($v["district_id"]); ?></td>
											<td ><?php echo ($v["game"]); ?></td>
											<td ><?php echo ($v["accessman"]); ?></td>
											<td ><?php echo ($v["leader_gamename"]); ?></td>
											<td ><a href="<?php echo U('Admin/Admin/deljfu',array('id' => $v[id]));?>">删除</a>|
										        <?php if($v['status']): ?>已阅            
										        <?php else: ?>
										              <a href="<?php echo U('Admin/Admin/runjfu',array('id' => $v[id]));?>">查看</a><?php endif; ?>
										    </td>
						...
						<div class="control-group">
							<div class="controls">
								<a href="<?php echo U('Export/jfexport');?>"><button class="btn btn-default">导出进服人员表</button></a>
							</div>
						</div>
				<div class="row-fluid">
