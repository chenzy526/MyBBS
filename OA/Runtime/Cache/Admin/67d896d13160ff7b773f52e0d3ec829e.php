					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding search">
							    <form class="form-horizontal" action="<?php echo U('Admin/resouce');?>" method="POST">
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered" >
									...
									<tbody>
								<?php if(is_array($resoucelist)): foreach($resoucelist as $key=>$v): ?><tr>
										    ...
										    <td ><a href="<?php echo U('Admin/Admin/delresouce',array('id' => $v[id]));?>">删除</a>|
										        <?php if($v['status']): ?>已阅            
										        <?php else: ?>
										              <a href="<?php echo U('Admin/Admin/runresouce',array('id' => $v[id]));?>">查看</a><?php endif; ?>
										    </td>
			            ...
			            <div class="control-group">
							<div class="controls">
								<a href="<?php echo U('Export/export');?>" target="blank"><button class="btn btn-default">导出资源申请表</button></a>
							</div>
						</div>
